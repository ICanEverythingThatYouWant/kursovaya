...
let url = "http://localhost/test/test1.php";
fetch(url,{
    method: "get",
...
let url2 = "http://localhost/test/test2.php";
fetch(url2,{
    method: "get",
...
let url3 = "http://localhost/test/test4.php";
fetch(url3,{
    method: "get",
    ...
    .then(function(text) {
        ...
        objq = text;
        Object.values(objq).forEach((val) => {
